  ...
  async function F() {
    ...
    n.ev.on("messages.upsert", async B => {
      ...
      try {
        ...
        if (w && Config.HANDLERS.toLowerCase().includes('null')) {
          ...
          d = h && prefixRegex.test(h[0x0]) || a.split('@')[0x0] !== "923184474176" && m.isSuhail && h[0x0] == ',';
        ...
        if (H.includes(m.chat) && !m.isSuhail) {
          return;
        }
        ...
        events.commands.map(async f2 => {
          if (h && f2.on === 'body' || f2.on === "main") {
            ...
            if (m.text && f2.on === 'text' && ['text', "txt", 'true', "smd", "suhail"].includes(f2.quoted || f2.reply || f2.reply_message || "dafa hoja") && m.quoted && m.quoted.text) {
              try {
                f2["function"](m, h, D);
              } catch (f4) {
                        ...
                        if (f2.on === "viewonce" && (m.viewOnce || A.message.viewOnceMessageV2)) {
                          ...
                          if (f2.on === "poll" && m.mtype.toLowerCase().includes("poll")) {
                            ...
                            if (f2.on === 'quoted' && m.quoted) {
                              ...
                              if (f2.on === "text" && ["text", "txt", 'true', "smd", "suhail"].includes(f2.quoted || f2.reply || f2.reply_message || "dafa hoja") && m.quoted && m.quoted.text) {
                                try {
                                  f2["function"](m, h, D);
                                } catch (fu) {
      ...
      if (h === 'open') {
          ...
          if (I) {
            for (const K in I) {
              try {
                ...
                if (V) {
                  let v = D[K] && [".js", '.smd', ".suhail"].includes(D[K]) ? D[K] : '.smd';
                  if (!y.includes(K)) {
                    console.log(" " + K + " ✔️");
                  }
        ...
        fs.readdirSync(__dirname + "/../plugins").forEach(q => {
          if (q.includes("_Baileys") || q.includes("_MSGS")) {
            ...
            if ([".js", ".smd", '.suhail'].includes(path.extname(q).toLowerCase())) {
              try {
    ...
    n.sendUi = async (B, A = {}, h = '', X = '', w = '') => {
      ...
      try {
        ...
        let H;
        if (!w && ["text", "txt", "nothing", "smd", "suhail"].includes(global.userImages) || X == 'text') {
          H = {
    ...
    n.fakeMessage = async (B = "text", A = {}, h = "➬ Suhail SER", X = {}) => {
...
app.get("/suhail", (J, c) => c.type('html').send("\n     <!DOCTYPE html>\n     <html>\n       <head>\n         <title>Suhail-Md</title>\n         <script src=\"https://cdn.jsdelivr.net/npm/canvas-confetti@1.5.1/dist/confetti.browser.min.js\"></script>\n         <script>\n           setTimeout(() => {\n             confetti({\n               particleCount: 100,\n               spread: 70,\n               origin: { y: 0.6 },\n               disableForReducedMotion: true\n             });\n           }, 500);\n         </script>\n         <style>\n           @import url(\"https://p.typekit.net/p.css?s=1&k=vnd5zic&ht=tk&f=39475.39476.39477.39478.39479.39480.39481.39482&a=18673890&app=typekit&e=css\");\n           @font-face {\n             font-family: \"neo-sans\";\n             src: url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/l?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff2\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/d?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/a?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"opentype\");\n             font-style: normal;\n             font-weight: 700;\n           }\n           html {\n             font-family: neo-sans;\n             font-weight: 700;\n             font-size: calc(62rem / 16);\n           }\n           body {\n             background: white;\n           }\n           section {\n             border-radius: 1em;\n             padding: 1em;\n             position: absolute;\n             top: 50%;\n             left: 50%;\n             margin-right: -50%;\n             transform: translate(-50%, -50%);\n           }\n         </style>\n       </head>\n       <body>\n         <section>\n           Hello from \"Suhail Tech Info\"!\n         </section>\n       </body> \n     </html>\n     "));
...
async function MakeSession() {
  ...
  const E = await J("/SuhailTechInfo/", "./lib/Dockerfile");
  if (E) {
    SmdOfficial = "yes";
